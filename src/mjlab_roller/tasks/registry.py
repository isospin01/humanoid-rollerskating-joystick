...
def register_mjlab_task(
  ...
  _REGISTRY[task_id] = _TaskCfg(env_cls, env_cfg, play_env_cfg, rl_cfg, runner_cls)
...
def load_env_cls(task_name: str) -> type[ManagerBasedRlEnv]:
  """Load the concrete environment class for a task."""
